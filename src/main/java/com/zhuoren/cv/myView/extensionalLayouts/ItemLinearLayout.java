 ...
 */
    ...
    //算法描述：重写LinearLayout#onTouchEvent方法，实现两个滑动，一是对
    //move事件使用LinearLayout#scrollTo使子布局实现跟手滑动。二是对up事件使用Scroller
    //配合LinearLayout#scrollTo使子布局自动向左展开或自动向右收缩。
...
public class ItemLinearLayout extends LinearLayout {
    ...
    public interface OnSwipeListener {
        ...
        void onDirectionJudged(ItemLinearLayout sll, boolean isHorizontal);
    }
